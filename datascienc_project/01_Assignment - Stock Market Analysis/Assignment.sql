...
round(avg(`Close Price`) over (rows between 1 preceding and 49 following),2) as 50_Day_MA from bajaj;
...
select Date, round(`Close Price`,2) as 'Close Price', 
round(avg(`Close Price`) over (rows between 0 preceding and 19 following),2) as 20_Day_MA,
round(avg(`Close Price`) over (rows between 1 preceding and 49 following),2) as 50_Day_MA from eicher;
...
select Date, round(`Close Price`,2) as 'Close Price', 
round(avg(`Close Price`) over (rows between 0 preceding and 19 following),2) as 20_Day_MA,
round(avg(`Close Price`) over (rows between 1 preceding and 49 following),2) as 50_Day_MA from hero;
...
select Date, round(`Close Price`,2) as 'Close Price', 
round(avg(`Close Price`) over (rows between 0 preceding and 19 following),2) as 20_Day_MA,
round(avg(`Close Price`) over (rows between 1 preceding and 49 following),2) as 50_Day_MA 
from infosys;
...
round(avg(`Close Price`) over (rows between 0 preceding and 19 following),2) as 20_Day_MA,
round(avg(`Close Price`) over (rows between 1 preceding and 49 following),2) as 50_Day_MA from tcs;
...
select Date, round(`Close Price`,2) as 'Close Price', 
round(avg(`Close Price`) over (rows between 0 preceding and 19 following),2) as 20_Day_MA,
round(avg(`Close Price`) over (rows between 1 preceding and 49 following),2) as 50_Day_MA from tvs;
